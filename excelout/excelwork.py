...
def get_ip_data():
    ...
    dogName = input("What is the name of your favorite dog? ")
    school = input("where did you go to school at ? ")
    d = {"IP": input_ip, "driver": input_driver, "DOg Name":dogName, "School": school}
    return d
